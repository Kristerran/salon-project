...
class AdminUpdateItemModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
          modalEdit: false,
      ...
      onSubmit = (id, title, price, size, tags, images, description) => {
      ...
      render() {
        const { title,  sizes, tags, images, description, price } = this.state
              ...
              <ModalFooter>
                <Button color="primary"
                  onClick={()=>this.onSubmit(
                    _id, title, price, sizes, tags, images, description)}>Confirm the changes?
                </Button>{' '}
...
export default AdminUpdateItemModal;
